...
{
    public class BoostableLeaf
    {
        //The number of split values to test when finding the best
        private const int nTestSplitValue = 250;
        ...
        protected BoostableLeaf output1 = null;
        protected BoostableLeaf output2 = null;
        protected double split;
        protected int variable;

        protected double nBackground = 0;
        protected double nSignal = 0;

        public BoostableLeaf() :
            this(0, 0)
        { }

        public BoostableLeaf(int variable, double split)
        {
        ...
        public double GetPurity()
        {
            ...
            return nSignal / (nBackground + nSignal);
        }
        ...
        public void Train(WeightedDataSet signal, WeightedDataSet background)
        {
            if (nVariables == 0)
            {
            ...
            nSignal = signal.GetWeightedSum();
            nBackground = background.GetWeightedSum();
            ...
            if (branch)
            {
                ...
                output1 = new BoostableLeaf();
                output2 = new BoostableLeaf();

                WeightedDataSet signalLeft = new WeightedDataSet();
                WeightedDataSet signalRight = new WeightedDataSet();
                WeightedDataSet backgroundLeft = new WeightedDataSet();
                WeightedDataSet backgroundRight = new WeightedDataSet();
        ...
        protected bool chooseVariable(WeightedDataSet signal, WeightedDataSet background)
        {
        ...
        private double[] findBestCut(WeightedDataSet signal, WeightedDataSet background, int variable)
        {
        ...
        private double testCut(WeightedDataSet signal, WeightedDataSet background, int variable, double cutValue)
        {
            WeightedDataSet signalLeft = new WeightedDataSet();
            WeightedDataSet signalRight = new WeightedDataSet();
            WeightedDataSet backgroundLeft = new WeightedDataSet();
            ...
            double purityLeft = (double) signalLeft.GetWeightedSum() / (backgroundLeft.GetWeightedSum()+signalLeft.GetWeightedSum());
            double purityRight = (double) signalRight.GetWeightedSum() / (backgroundRight.GetWeightedSum()+signalRight.GetWeightedSum());
